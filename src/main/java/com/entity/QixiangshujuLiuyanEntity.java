...
public class QixiangshujuLiuyanEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public QixiangshujuLiuyanEntity() {

	}

	public QixiangshujuLiuyanEntity(T t) {
		try {
    ...
    public String toString() {
        return "QixiangshujuLiuyan{" +
            ", id=" + id +
            ", qixiangshujuId=" + qixiangshujuId +
            ", yonghuId=" + yonghuId +
            ", qixiangshujuLiuyanText=" + qixiangshujuLiuyanText +
