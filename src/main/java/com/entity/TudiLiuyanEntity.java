...
public class TudiLiuyanEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public TudiLiuyanEntity() {

	}

	public TudiLiuyanEntity(T t) {
		try {
    ...
    @TableField(value = "tudi_liuyan_text")

    private String tudiLiuyanText;
	 ...
	 * 获取：留言内容
	 */
    public String getTudiLiuyanText() {
        return tudiLiuyanText;
    }
    /**
	 * 设置：留言内容
	 */

    public void setTudiLiuyanText(String tudiLiuyanText) {
        this.tudiLiuyanText = tudiLiuyanText;
    }
    /**
	 * 获取：留言时间
	 */
