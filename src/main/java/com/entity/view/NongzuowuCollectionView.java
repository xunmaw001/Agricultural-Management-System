...
public class NongzuowuCollectionView extends NongzuowuCollectionEntity implements Serializable {
	...
	*/
	...
	private String nongzuowuCollectionValue;
	...
	public NongzuowuCollectionView() {

	}

	public NongzuowuCollectionView(NongzuowuCollectionEntity nongzuowuCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, nongzuowuCollectionEntity);
	...
	* 获取： 类型的值
	*/
	public String getNongzuowuCollectionValue() {
		return nongzuowuCollectionValue;
	}
	/**
	* 设置： 类型的值
	*/
	public void setNongzuowuCollectionValue(String nongzuowuCollectionValue) {
		this.nongzuowuCollectionValue = nongzuowuCollectionValue;
	}
	...
	public String toString() {
		return "NongzuowuCollectionView{" +
			", nongzuowuCollectionValue=" + nongzuowuCollectionValue +
