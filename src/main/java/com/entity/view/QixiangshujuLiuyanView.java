...
public class QixiangshujuLiuyanView extends QixiangshujuLiuyanEntity implements Serializable {
	...
	public QixiangshujuLiuyanView() {

	}

	public QixiangshujuLiuyanView(QixiangshujuLiuyanEntity qixiangshujuLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, qixiangshujuLiuyanEntity);
