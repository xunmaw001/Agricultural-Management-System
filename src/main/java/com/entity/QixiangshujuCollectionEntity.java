...
public class QixiangshujuCollectionEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public QixiangshujuCollectionEntity() {

	}

	public QixiangshujuCollectionEntity(T t) {
		try {
     ...
     * 气象数据
     */
    @ColumnInfo(comment="气象数据",type="int(11)")
    ...
    @TableField(value = "qixiangshuju_collection_types")
    ...
    public String toString() {
        return "QixiangshujuCollection{" +
            ", id=" + id +
            ", qixiangshujuId=" + qixiangshujuId +
            ", yonghuId=" + yonghuId +
