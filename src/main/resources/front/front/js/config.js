...
var centerMenu = [
    ...
    ,{
        name: '农作物收藏',
        url: '../nongzuowuCollection/list.html'
    }
    ,{
        name: '气象数据收藏',
        url: '../qixiangshujuCollection/list.html'
    }
    ,{
        name: '商品收藏',
...
var indexNav = [
    ...
    {
        name: '气象数据',
        url: './pages/qixiangshuju/list.html'
    },
    {
        name: '商品',
...
// 已废弃,不用了
var adminurl =  "http://localhost:8080/nongshiguanli/admin/dist/index.html#/login";
