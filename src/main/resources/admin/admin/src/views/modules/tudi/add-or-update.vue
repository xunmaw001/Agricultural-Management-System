               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="土地位置" prop="tudiAddress">
                       <el-input v-model="ruleForm.tudiAddress"
                                 placeholder="土地位置" clearable  :readonly="ro.tudiAddress"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="土地面积(平方)" prop="tudiMianji">
                       <el-input v-model="ruleForm.tudiMianji"
                                 placeholder="土地面积(平方)" clearable  :readonly="ro.tudiMianji"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                ...
                <el-col :span="12">
                    <el-form-item v-if="type!='info' && !ro.tudiTime"  class="input" label="规划时间" prop="tudiTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.tudiTime"
                                type="datetime"
                                placeholder="规划时间"
                                :disabled="ro.tudiTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.tudiTime" label="规划时间" prop="tudiTime">
                            <span v-html="ruleForm.tudiTime"></span>
                        </el-form-item>
                    </div>
                </el-col>

                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.tudiContent"  label="土地备注" prop="tudiContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.tudiContent" label="土地备注" prop="tudiContent">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   tudiMianji: [
                              { required: true, message: '土地面积(平方)不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   tudiClicknum: [
                              { required: true, message: '土地热度不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   tudiContent: [
                              { required: true, message: '土地备注不能为空', trigger: 'blur' },
                          ],
                   shangxiaTypes: [
